...
const features: Feature[] = [
  ...
  },
  {
    ...
    description: "Comprehensive articles and FAQs to",
  },
  {
    icon: UsersIcon,
    label: "Team Access",
    description: "Allow multiple team members to collaborate",
  },
  {
    icon: PaletteIcon,
    label: "Custom Branding",
    description: "Personalize your customer support interface",
  },
];
