...
const vapiFeatures: Feature[] = [
  {
    ...
    description:
      "Make and receive voice calls directly from your web app using Vapi's AI-powered voice capabilities.",
  },
  {
    icon: PhoneIcon,
    label: "Phone numbers",
    description:
      "Get dedicated business lines for your organization to manage calls efficiently.",
  },
  {
    icon: PhoneCallIcon,
    label: "Outbound calls",
    description:
      "Automated customer outreach and follow-ups with AI-driven voice calls.",
  },
  {
    icon: WorkflowIcon,
    label: "Workflows",
    description:
      "Create custom call workflows to streamline customer interactions and support.",
  },
];
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent>
        ...
        <DialogDescription>
          Your API keys are securely stored and used to connect your Vapi
          account.
        </DialogDescription>
        <Form {...form}>
          <form
